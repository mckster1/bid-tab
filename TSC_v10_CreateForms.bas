...
Private mCode As String          ' accumulates VBA source lines

' Append one line of VBA source
...
Private Function MkForm(ByVal vbp As Object, ByVal n As String, _
    ...
    c.Name = n: c.Designer.Caption = cap
    c.Designer.Width = W: c.Designer.Height = H
    Set MkForm = c
End Function
...
Private Sub Btn(ByVal d As Object, ByVal n As String, ByVal cap As String, _
                ByVal lft As Single, ByVal tp As Single, ByVal W As Single, ByVal H As Single, _
...
Private Sub BuildScopeEntry(ByVal vbp As Object)
    ...
    L "End Sub"
    L ""
    L "Private Sub optIncluded_Click(): txtAmount.Enabled = False: End Sub"
    L "Private Sub optExcluded_Click(): txtAmount.Enabled = False: End Sub"
    L "Private Sub optSkip_Click():     txtAmount.Enabled = False: End Sub"
    L ""
    ...
    L "End Sub"
    L ""
    L "Private Sub btnStop_Click(): Result = ""STOP"": Me.Hide: End Sub"
    L ""
    L "Private Sub UserForm_QueryClose(Cancel As Integer, CloseMode As Integer)"
    L "    If CloseMode = vbFormControlMenu Then"
    L "        Result = ""STOP"""
...
Private Sub BuildAddBidder(ByVal vbp As Object)
    ...
    L ""
    L "Public Property Get Company() As String:  Company = Trim$(txtCompany.Text): End Property"
    L "Public Property Get Contact() As String:  Contact = Trim$(txtContact.Text): End Property"
    L "Public Property Get Phone() As String:    Phone   = Trim$(txtPhone.Text):   End Property"
    L "Public Property Get Email() As String:    Email   = Trim$(txtEmail.Text):   End Property"
    L ""
    L "Private Sub UserForm_Initialize(): Cancelled = True: End Sub"
    L ""
    L "Private Sub btnNext_Click(): Cancelled = False: Me.Hide: End Sub"
    L "Private Sub btnCancel_Click(): Cancelled = True: Me.Hide: End Sub"
    L ""
    L "Private Sub UserForm_QueryClose(Cancel As Integer, CloseMode As Integer)"
    L "    If CloseMode = vbFormControlMenu Then"
    L "        Cancelled = True: Cancel = 1: Me.Hide"
    L "    End If"
    L "End Sub"
    SetCode comp
End Sub
...
Private Sub BuildAddBidder2(ByVal vbp As Object)
    ...
    L "Public Cancelled As Boolean"
    L ""
    L "Public Property Get DateReceived() As String: DateReceived = Trim$(txtDate.Text):    End Property"
    L "Public Property Get Notes() As String:        Notes        = Trim$(txtNotes.Text):   End Property"
    L "Public Property Get BaseBid() As String:      BaseBid      = Trim$(txtBaseBid.Text): End Property"
    L "Public Property Get ReEnterScope() As Boolean: ReEnterScope = chkReEnter.Value:      End Property"
    L ""
    L "Private Sub UserForm_Initialize()"
    L "    Cancelled = True"
    ...
    L "End Sub"
    L ""
    L "Private Sub btnAdd_Click(): Cancelled = False: Me.Hide: End Sub"
    L "Private Sub btnCancel_Click(): Cancelled = True: Me.Hide: End Sub"
    L ""
    L "Private Sub UserForm_QueryClose(Cancel As Integer, CloseMode As Integer)"
    L "    If CloseMode = vbFormControlMenu Then"
...
Private Sub BuildJobInfo(ByVal vbp As Object)
    ...
    L "Public Cancelled As Boolean"
    L ""
    L "Public Property Get ProjName() As String:  ProjName  = Trim$(txtProjName.Text):  End Property"
    L "Public Property Get Estimator() As String: Estimator = Trim$(txtEstimator.Text): End Property"
    L "Public Property Get BidDate() As String:   BidDate   = Trim$(txtBidDate.Text):   End Property"
    L "Public Property Get JobGSF() As String:    JobGSF    = Trim$(txtJobGSF.Text):    End Property"
    L ""
...
Private Sub BuildJobInfo2(ByVal vbp As Object)
    ...
    L ""
    L "Public Property Get TradeSF() As String: TradeSF = Trim$(txtTradeSF.Text): End Property"
    L ""
    L "Private Sub UserForm_Initialize()"
    L "    Cancelled = True"
    L "    OverwriteScope = 2"
